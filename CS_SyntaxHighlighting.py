...
STYLES2 = {
    ...
    'defnamespace': format([100, 30, 240], 'bold'),
...
STYLES = {
       ...
       'operator': format('red'),
       'brace'   : format('darkGray'),
       'defclass': format('yellow', 'bold'),
       'defnamespace': format('orange', 'bold'),
...
class CSHighlighter(QSyntaxHighlighter):
    ...
    contextual_keywords = [
        ...
        'global'   , 'group' , 'init'   , 'into'      ,
        'join'     , 'let'   , 'managed', 'nameof'    ,
        'nint'     , 'not'   , 'notnull', 'nuint'     ,
        'on'       , 'or'    , 'orderby', 'partial'   ,
        'record'   , 'remove', 'select' , 'set'       ,
    ...
    def __init__(self, document):
        ...
        rules += [(r'\b%s\b' % w, 0, STYLES['keyword'])
                  for w in CSHighlighter.reserved_keywords]
        ...
        rules += [
            ...
            (r'\bnamespace\b\s*(\w+)', 1, STYLES['defnamespace']),
